package httpapi // JSON DTO для создания заказа и ответа клиенту

import "github.com/example/go-examples/mysql-ms/internal/domain"
...
func ToOrderResponse(o *domain.Order) OrderResponse {
	...
	return OrderResponse{
		...
		Items: dto, TotalCents: o.TotalCents(),
